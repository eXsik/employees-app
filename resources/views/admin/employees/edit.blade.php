<x-admin-layout>
    <h1 class="text-3xl font-medium py-4">Edit Employee {{ $employee->id }}</h1>
    <x-splade-form :action="route('admin.employees.update', $employee)" method="PUT" class="p-4 bg-white rounded-md"
        :default="$employee">
