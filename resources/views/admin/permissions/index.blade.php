<x-admin-layout>
    <div class="flex justify-between">
        <h1 class="text-3xl font-medium py-4">Permissions</h1>
        <div class="py-4">
        ...
        @cell('action', $permission)
            <div class="space-x-1">
                ...
                <Link href="{{ route('admin.permissions.destroy', $permission) }}" method="DELETE"
                    confirm="Are you sure you want to delete this permission?" confirm-button="Yes" cancel-button="No"
                    confirm-danger class="py-1.5 px-2.5 pr-0 rounded-md text-red-500 hover:text-red-600 tranition font-semibold">
                Delete
                </Link>
            </div>
        @endcell
